...
L.TEXTURE_EXAMPLE = "Example: ###.tga. Leave the texture file empty to disable the image and animation."
L.SOUND_EXAMPLE = "Example: ###.mp3. Leave the sound file empty to disable audio playback."
L.SPRITE_HINT = ""
L.APPLY = "Apply"
L.DEFAULT = "Default"
